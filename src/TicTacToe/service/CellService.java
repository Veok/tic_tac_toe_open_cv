...
public class CellService {
    ...
    private void setListOfCells() {
        ...
        listOfCells.add(new Cell(new Point(800, 90), SECOND_COLUMN, THIRD_COLUMN, 0, FIST_LINE));
        listOfCells.add(new Cell(new Point(160, 270), 0, FIRST_COLUMN, FIST_LINE, SECOND_LINE));
        listOfCells.add(new Cell(new Point(480, 270), FIRST_COLUMN, SECOND_COLUMN, FIST_LINE, SECOND_LINE));
        listOfCells.add(new Cell(new Point(800, 270), SECOND_COLUMN, THIRD_COLUMN, FIST_LINE, SECOND_LINE));
